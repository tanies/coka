                    ...
                    files.forEach(function (file, idx) {
                        fs.stat(path + '/' + file, function (err, stat) {
                            ...
                            if (/.js$/.test(file)) {
                                ...
                                //获得已有值或者初始化值
                                global[CONFIG][configKey] = global[CONFIG][configKey] || {}

                                //合并
                                global[CONFIG][configKey] = Object.assign(global[CONFIG][configKey], _file.index(), (_file[NODE_ENV] && _file[NODE_ENV]()) || {});
